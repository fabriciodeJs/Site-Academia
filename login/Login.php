...
<body>
        ...
        <div class="container" id="nav-container">
            <nav class="navbar navbar-expand-lg fixed-top">
                <a href="index.html" class="navbar-brand">
                    <a href="/Trabalho final/index/index.html"><img id="logo" src="logo/logo_10-removebg-preview.png" alt="hDC Agency"></a>
                </a>
        ...
        <div id="container-input">
            <div id="titulo-input">
                ...
                <!--onsubmit="logar(event)"-->
                    ...
                    <input id="senha" name="senha" class="input" type="password"
                        placeholder="                                  SENHA">
                    <input id="btn" name="submit" class="input" type="submit" value="Entrar >">
                    <p id="p"><a id="cadastro" href="\Trabalho final\cadastro\Cadastro.php">Cadastra-se</a> Caso não seja aluno</p>
                </form>
                <?php
    ...
    <!--<script src="/Trabalho final/cadastro/Cadastro.js"></script>-->
</body>
